	...
	function studAuthentication($U_USERNAME,$h_pass){
		...
		$row_count = $mydb->num_rows($cur);//get the number of count
		 ...
		 $student_found = $mydb->loadSingleResult();
			...
			$_SESSION['EXT']			= $student_found->EXT;
			$_SESSION['MNAME']			= $student_found->MNAME; 
			$_SESSION['CURRENT_ADD']	= $student_found->CURRENT_ADD; 
			$_SESSION['PERMANENT_ADD']	= $student_found->PERMANENT_ADD; 
