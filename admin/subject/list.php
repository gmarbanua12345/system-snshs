...
<div class="row">
      <div class="col-lg-12">
       	 <div class="col-lg-8">
            <h2 class="page-header">List of Subjects per Grade Level <a href="index.php?view=add" class="btn btn-primary btn-sm ">  <i class="fa fa-plus-circle fw-fa fa-lg"></i>  Add New</a>  </h2>
       		</div>
       		<div class="col-lg-4" >
