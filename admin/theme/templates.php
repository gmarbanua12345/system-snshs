...
<link href="<?php echo web_root; ?>admin/css/styles.css" rel="stylesheet">
   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="<?php echo web_root; ?>img/logocircle1.png" height="40">
                SNHS  </a>
            </div>
            <!-- /.navbar-header -->
...
?> 
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                      ...
                      <li><a title="Edit" href="<?php echo web_root; ?>admin/user/index.php?view=edit&id=<?php echo $_SESSION['ACCOUNT_ID']; ?>"  >
                    </a>
   ...
   <!-- /input-group -->
                        <li>
                            <a href="<?php echo web_root; ?>admin/index.php"><i class="fa-solid fa-table fa-lg"></i> Dashboard</a>
                        </li>
                         <li>
                             <a href="<?php echo web_root; ?>admin/enrollees/index.php" ><i class="fa fa-calendar fa-fw fa-lg"></i>  New Enrollees 
                             <label class="label pull-right label-primary"><?php echo isset($enrollees->enrollees) ? $enrollees->enrollees : 0; ?></label> </a>
                              
                        </li>
                      
                        <li>
                             <a href="<?php echo web_root; ?>admin/subject/index.php"><i class="fa-solid fa-book fa-lg"></i>  Subjects </a>
           
                        </li>
                        
                           
                         <li>
                             <a href="<?php echo web_root; ?>admin/course/index.php" ><i class="fa  fa-graduation-cap fa-fw fa-lg"></i>  Year Level/Strand </a>
            
                        </li>
                        <li>
                             <a href="<?php echo web_root; ?>admin/schedule/index.php" ><i class="fa fa-calendar fa-fw fa-lg"></i>  Schedule </a>
            
                        </li>
                        <li>
                             <a href="<?php echo web_root; ?>admin/student/index.php" ><i class="fa-solid fa-user-graduate fa-lg"></i>  Students </a>
            
                        </li>
                        <?php if ($_SESSION['ACCOUNT_TYPE']=='Administrator') {
                        ?>
                        <li>
                             <a href="<?php echo web_root; ?>admin/instructor/index.php" ><i class="fa fa-group fa-fw fa-lg"></i> Teacher</a>
                           ...
                           <li>
                            ...
                            <a href="#"><i class="fa  fa-file-text fa-fw fa-lg"></i> Report <span class="fa arrow"></span></a>
                                ...
                                <li>
                                    <a href="#">Class List  <span class="fa arrow"></span></a>
                                     <ul  class="nav nav-third-level">
                                        ...
                                        <li><a href="<?php echo web_root; ?>admin/report/index.php?view=perCourse" >Students Enrolled per Grade/Strand</a></li>
                        ...
                        ?>
                          <li>
                            <a href="<?php echo web_root; ?>admin/user/index.php" ><i class="fa-solid fa-users fa-lg"></i> Users </a>
  ...
  <div id="page-wrapper">
    ...
    <!-- /#wrapper -->
      ...
      <!-- <footer><p align="Left">&copy; SNHS Balugo Extension Enrollment System </p></footer> -->
