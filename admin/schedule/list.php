...
<div class="row">
      <div class="col-lg-12">
       	 <div class="col-lg-6">
            <h1 class="page-header">List of Schedule  <a href="index.php?view=add" class="btn btn-primary btn-sm ">   <i class="fa fa-plus-circle fw-fa fa-lg"></i> Add New Schedule</a>  </h1>
       		</div>
       		<div class="col-lg-6" >
				  ...
				  <tbody>
				  	...
				  	$sql="SELECT * FROM tblinstructor i,`tblschedule` s, `course` c, subject subj WHERE i.INST_ID=s.INST_ID AND s.`COURSE_ID`=c.`COURSE_ID` AND s.SUBJ_ID=subj.SUBJ_ID";
						...
						if($result->COURSE_MAJOR != "N/A"){
							...
							echo '<td>' . $result->COURSE_NAME.' - Grade ' . $result->COURSE_LEVEL.'</td>';
						}
