      ...
      <div class="row">
        <div class="col-xs-12 col-md-12">
          <table class="table table-bordered table-striped" style="font-size:11px" cellspacing="0" >
            ...
            <tbody>
              <?php
                $tot = 0; 
                 ...
                 WHERE i.`INST_ID`=sc.`INST_ID` AND sc.`SUBJ_ID`=ss.`SUBJ_ID` AND ss.`IDNO`=s.`IDNO` 
                 AND s.COURSE_ID = c.COURSE_ID  AND i.`INST_ID`=" .$_POST['INST_ID']. " 
            ...
            <tfoot>
              <tr>
                <td colspan="5" align="right"><h2>Total Number of Student/s : </h2></td><td><h2><?php echo $tot ; ?></h2></td>
              </tr>
            </tfoot>
          </table>
        </div>
