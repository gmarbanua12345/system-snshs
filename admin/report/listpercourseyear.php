 ...
 <form action="" method="POST" >
      ...
      <?php 
        ...
        foreach ($cur as $result) {
          if($result->COURSE_MAJOR == "N/A"){
            ...
            echo '<option value="'.$result->COURSE_NAME.'-'.$result->COURSE_LEVEL.'" >'.$result->COURSE_NAME.'-'.$result->COURSE_LEVEL.' ('.$result->COURSE_MAJOR.') </option>';
          }
   ...
   <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i  class="fa fa-globe">List Of Students Enrolled per Grade Level</i>
              <small class="pull-right"> <?php echo (isset($_POST['Course'])) ? 'Grade Level :' .$_POST['Course'] : ''; ?>
            ...
            <tbody>
              ...
              ?>
                      <tr> 
                        ...
                        <td><?php echo $result->FNAME . ' ' .  $result->MNAME . '  ' .  $result->LNAME . '  ' .  $result->EXT;?></td>
                        <td><?php echo $result->CURRENT_ADD;?></td>
                        <td><?php echo $result->SEX;?></td>
                        <td><?php echo  date_diff(date_create($dbirth),date_create($today))->y;?></td>
                        <td><?php echo $result->COURSE_NAME .' - Grade '.$result->COURSE_LEVEL;?></td>
